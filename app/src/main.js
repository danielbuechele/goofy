...
function createWindow() {
	...
	mainWindow.webContents.on('dom-ready', () => {
		...
		if (store.get(userConfig.COLLAPSE_SIDEBAR, false)) {
			mainWindow.webContents.insertCSS(fs.readFileSync(path.join(__dirname, '/assets/fb-collapse-sidebar.css'), 'utf8'));
		}
